...
export default function DisplayTeamTask() {
  const { getTeamTask, teamTask } = useTeamTask();
  ...
  return (
    <section className="bg-gray-50 py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
              ...
              <div key={memberIndex} className="bg-white rounded-lg shadow-lg p-6">
                ...
                <div className="space-y-4">
                  {member.tasks.map((task: any, taskIndex: number) => (
                    <div key={taskIndex} className="bg-gray-50 p-4 rounded-lg shadow-md hover:bg-gray-100 transition duration-300">
